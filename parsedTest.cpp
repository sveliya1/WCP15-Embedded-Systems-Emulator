...
label_c6:;
	//Could not parse:   c6:	4a10      	ldr	r2, [pc, #64]	 ; (108 <_stop_init+0x44>) ;
label_c8:;
	//Could not parse:   c8:	4b10      	ldr	r3, [pc, #64]	 ; (10c <_stop_init+0x48>) ;
label_ca:;
	LSLS_3(r1, r1, 6);//  ca:	0189      	lsls	r1, r1, #6 ;
label_cc:;
	LDR_3(r0, r2, r3);//  cc:	58d0      	ldr	r0, [r2, r3] ;
label_ce:;
	PUSH(sp, 0b000011000);//  ce:	b530      	PUSH	r4, r5, lr ;
label_d0:;
	ORRS_2(r1, r0);//  d0:	4301      	orrs	r1, r0 ;
label_d2:;
	STR_3(r1, r2, r3);//  d2:	50d1      	str	r1, [r2, r3] ;
label_d4:;
	//Could not parse:   d4:	490e      	ldr	r1, [pc, #56]	 ; (110 <_stop_init+0x4c>) ;
label_d6:;
	//Could not parse:   d6:	4c0f      	ldr	r4, [pc, #60]	 ; (114 <_stop_init+0x50>) ;
label_d8:;
...
label_ea:;
	//Could not parse:   ea:	4c0b      	ldr	r4, [pc, #44]	 ; (118 <_stop_init+0x54>) ;
label_ec:;
...
label_100:;
	//Could not parse:  100:	4806      	ldr	r0, [pc, #24]	 ; (11c <_stop_init+0x58>) ;
label_102:;
...
label_128:;
	//Could not parse:  128:	4b2e      	ldr	r3, [pc, #184]	 ; (1e4 <_reset_init+0xc4>) ;
label_12a:;
	LSLS_3(r2, r2, 5);// 12a:	0152      	lsls	r2, r2, #5 ;
label_12c:;
	printf("1st store start");
	STR_3(r1, r3, r2);// 12c:	5099      	str	r1, [r3, r2] ;
	printf("1st store done");
label_12e:;
	//Could not parse:  12e:	482e      	ldr	r0, [pc, #184]	 ; (1e8 <_reset_init+0xc8>) ;
label_130:;
	//Could not parse:  130:	4a2e      	ldr	r2, [pc, #184]	 ; (1ec <_reset_init+0xcc>) ;
label_132:;
	STR_3(r0, r2, 8);// 132:	6090      	str	r0, [r2, #8] ;
label_134:;
	MOVS_2(r2, 128);// 134:	2280      	movs	r2, #128	 ; 0x80 ;
label_136:;
	//Could not parse:  136:	482e      	ldr	r0, [pc, #184]	 ; (1f0 <_reset_init+0xd0>) ;
label_138:;
...
label_140:;
	//Could not parse:  140:	482c      	ldr	r0, [pc, #176]	 ; (1f4 <_reset_init+0xd4>) ;
label_142:;
	//Could not parse:  142:	4a2d      	ldr	r2, [pc, #180]	 ; (1f8 <_reset_init+0xd8>) ;
label_144:;
	STR_3(r0, r3, r2);// 144:	5098      	str	r0, [r3, r2] ;
label_146:;
	LDR_3(r2, r3, 0);// 146:	681a      	ldr	r2, [r3, #0] ;
label_148:;
	//Could not parse:  148:	482c      	ldr	r0, [pc, #176]	 ; (1fc <_reset_init+0xdc>) ;
label_14a:;
...
label_150:;
	//Could not parse:  150:	4a2b      	ldr	r2, [pc, #172]	 ; (200 <_reset_init+0xe0>) ;
label_152:;
...
label_15c:;
	//Could not parse:  15c:	4c29      	ldr	r4, [pc, #164]	 ; (204 <_reset_init+0xe4>) ;
label_15e:;
...
label_168:;
	//Could not parse:  168:	4b27      	ldr	r3, [pc, #156]	 ; (208 <_reset_init+0xe8>) ;
label_16a:;
	//Could not parse:  16a:	4c28      	ldr	r4, [pc, #160]	 ; (20c <_reset_init+0xec>) ;
label_16c:;
...
label_17e:;
	//Could not parse:  17e:	4b24      	ldr	r3, [pc, #144]	 ; (210 <_reset_init+0xf0>) ;
label_180:;
	//Could not parse:  180:	7018      	strb	r0, [r3, #0] ;
label_182:;
	//Could not parse:  182:	4b24      	ldr	r3, [pc, #144]	 ; (214 <_reset_init+0xf4>) ;
label_184:;
...
label_1c0:;
	//Could not parse:  1c0:	4815      	ldr	r0, [pc, #84]	 ; (218 <_reset_init+0xf8>) ;
label_1c2:;
	//Could not parse:  1c2:	4916      	ldr	r1, [pc, #88]	 ; (21c <_reset_init+0xfc>) ;
label_1c4:;
	//Could not parse:  1c4:	4c16      	ldr	r4, [pc, #88]	 ; (220 <_reset_init+0x100>) ;
label_1c6:;
...
label_1ce:;
	//Could not parse:  1ce:	4a15      	ldr	r2, [pc, #84]	 ; (224 <_reset_init+0x104>) ;
label_1d0:;
...
{
label_42c:;
	PUSH(sp, 0b000011100);// 42c:	b570      	PUSH	r4, r5, r6, lr ;
label_42e:;
...
label_44e:;
	//Could not parse:  44e:	4914      	ldr	r1, [pc, #80]	 ; (4a0 <configure_rgbled+0x54>) ;
label_450:;
	//Could not parse:  450:	4a14      	ldr	r2, [pc, #80]	 ; (4a4 <configure_rgbled+0x58>) ;
label_452:;
...
label_45a:;
	//Could not parse:  45a:	4b13      	ldr	r3, [pc, #76]	 ; (4a8 <configure_rgbled+0x5c>) ;
label_45c:;
	//Could not parse:  45c:	4813      	ldr	r0, [pc, #76]	 ; (4ac <configure_rgbled+0x60>) ;
label_45e:;
...
label_47a:;
	//Could not parse:  47a:	4b0d      	ldr	r3, [pc, #52]	 ; (4b0 <configure_rgbled+0x64>) ;
label_47c:;
...
label_48a:;
	//Could not parse:  48a:	4a0a      	ldr	r2, [pc, #40]	 ; (4b4 <configure_rgbled+0x68>) ;
label_48c:;
...
label_496:;
	//Could not parse:  496:	4a08      	ldr	r2, [pc, #32]	 ; (4b8 <configure_rgbled+0x6c>) ;
label_498:;
...
label_4be:;
	//Could not parse:  4be:	4a03      	ldr	r2, [pc, #12]	 ; (4cc <turn_on_green_led+0x10>) ;
label_4c0:;
...
label_4d2:;
	//Could not parse:  4d2:	4a03      	ldr	r2, [pc, #12]	 ; (4e0 <turn_off_green_led+0x10>) ;
label_4d4:;
...
label_4e6:;
	//Could not parse:  4e6:	4a03      	ldr	r2, [pc, #12]	 ; (4f4 <toggle_green_led+0x10>) ;
label_4e8:;
...
label_4fa:;
	//Could not parse:  4fa:	4a03      	ldr	r2, [pc, #12]	 ; (508 <turn_on_red_led+0x10>) ;
label_4fc:;
...
label_50e:;
	//Could not parse:  50e:	4a03      	ldr	r2, [pc, #12]	 ; (51c <turn_off_red_led+0x10>) ;
label_510:;
...
label_522:;
	//Could not parse:  522:	4a03      	ldr	r2, [pc, #12]	 ; (530 <toggle_red_led+0x10>) ;
label_524:;
...
label_536:;
	//Could not parse:  536:	4a02      	ldr	r2, [pc, #8]	 ; (540 <turn_on_blue_led+0xc>) ;
label_538:;
...
label_546:;
	//Could not parse:  546:	4a02      	ldr	r2, [pc, #8]	 ; (550 <turn_off_blue_led+0xc>) ;
label_548:;
...
label_556:;
	//Could not parse:  556:	4a03      	ldr	r2, [pc, #12]	 ; (564 <toggle_blue_led+0x10>) ;
label_558:;
...
{
label_568:;
	PUSH(sp, 0b000010000);// 568:	b510      	PUSH	r4, lr ;
label_56a:;
