...
#define PRIVATE_SIZE 0xE00FFFFF+1 - PRIVATE_PERI_START
	...
	label_13e:;
		...
		if (Z_flag == 0) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_13a;
		};// 13e:	d1fc      	bnen	13a <_reset_init+0x72> ;
	label_140:;
	...
	label_148:;
		...
		if (Z_flag == 0) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_142;
		};// 148:	d1fb      	bnen	142 <_reset_init+0x7a> ;
	label_14a:;
	...
	label_152:;
		...
		if (Z_flag == 1) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_14e;
		};// 152:	d0fc      	beqn	14e <_reset_init+0x86> ;
	label_154:;
	...
	label_160:;
		...
		if (Z_flag == 0) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_15a;
		};// 160:	d1fb      	bnen	15a <_reset_init+0x92> ;
	label_162:;
	...
	label_16e:;
		...
		if (C_flag == 0) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_17c;
		};// 16e:	d305      	bccn	17c <_reset_init+0xb4> ;
	label_170:;
	...
	label_176:;
		...
		if (C_flag == 0 && Z_flag == 1) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_184;
		};// 176:	d905      	blsn	184 <_reset_init+0xbc> ;
	label_178:;
		g_cycle_count += 3;
	...
	label_204:;
		...
		if (Z_flag == 1) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_200;
		};// 204:	d0fc      	beqn	200 <_stop_init+0x34> ;
	label_206:;
	...
	label_570:;
		...
		if (Z_flag == 0) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_580;
		};// 570:	d106      	bnen	580 <set_rgbled_color_to+0x14> ;
	label_572:;
		g_cycle_count += 3;
	...
	label_582:;
		...
		if (Z_flag == 0) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_58a;
		};// 582:	d102      	bnen	58a <set_rgbled_color_to+0x1e> ;
	label_584:;
		g_cycle_count += 3;
	...
	label_58c:;
		...
		if (Z_flag == 0) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_598;
		};// 58c:	d104      	bnen	598 <set_rgbled_color_to+0x2c> ;
	label_58e:;
		g_cycle_count += 3;
	...
	label_59a:;
		...
		if (Z_flag == 0) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_5a2;
		};// 59a:	d102      	bnen	5a2 <set_rgbled_color_to+0x36> ;
	label_59c:;
		g_cycle_count += 3;
	...
	label_5a4:;
		...
		if (Z_flag == 0) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_5b4;
		};// 5a4:	d106      	bnen	5b4 <set_rgbled_color_to+0x48> ;
	label_5a6:;
		g_cycle_count += 3;
	...
	label_5b6:;
		...
		if (Z_flag == 0) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_5be;
		};// 5b6:	d102      	bnen	5be <set_rgbled_color_to+0x52> ;
	label_5b8:;
		g_cycle_count += 3;
	...
	label_5c0:;
		...
		if (Z_flag == 0) {
			g_cycle_count += 2; //thumb 'narrow' version
			goto label_5cc;
		};// 5c0:	d104      	bnen	5cc <set_rgbled_color_to+0x60> ;
	label_5c2:;
		g_cycle_count += 3;
