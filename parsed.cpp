...
label_c6:  ;
LDR(r2, 0x4004700);//  c6:	4a10      	ldr	r2, [pc, #64]	 ; (108 <_stop_init+0x44>) ;
label_c8:  ;
LDR(r3, 0x0000103);//  c8:	4b10      	ldr	r3, [pc, #64]	 ; (10c <_stop_init+0x48>) ;
label_ca:  ;
...
label_d4:  ;
LDR(r1, 0x4004d00);//  d4:	490e      	ldr	r1, [pc, #56]	 ; (110 <_stop_init+0x4c>) ;
label_d6:  ;
LDR(r4, 0xfffff8f);//  d6:	4c0f      	ldr	r4, [pc, #60]	 ; (114 <_stop_init+0x50>) ;
label_d8:  ;
...
label_ea:  ;
LDR(r4, 0x400ff10);//  ea:	4c0b      	ldr	r4, [pc, #44]	 ; (118 <_stop_init+0x54>) ;
label_ec:  ;
...
label_100:  ;
LDR(r0, 0xffffdff);// 100:	4806      	ldr	r0, [pc, #24]	 ; (11c <_stop_init+0x58>) ;
label_102:  ;
...
label_128:  ;
LDR(r3, 0x4004700);// 128:	4b2e      	ldr	r3, [pc, #184]	 ; (1e4 <_reset_init+0xc4>) ;
label_12a:  ;
LSLS(r2, r2, 5);// 12a:	0152      	lsls	r2, r2, #5 ;
label_12c:  ;
STR(r1, r3, r2);// 12c:	5099      	str	r1, [r3, r2] ;
label_12e:  ;
LDR(r0, 0x0000000);// 12e:	482e      	ldr	r0, [pc, #184]	 ; (1e8 <_reset_init+0xc8>) ;
label_130:  ;
LDR(r2, 0xe000ed0);// 130:	4a2e      	ldr	r2, [pc, #184]	 ; (1ec <_reset_init+0xcc>) ;
label_132:  ;
STR(r0, r2, 8);// 132:	6090      	str	r0, [r2, #8] ;
label_134:  ;
MOVS(r2, 128);// 134:	2280      	movs	r2, #128	 ; 0x80 ;
label_136:  ;
LDR(r0, 0x0000103);// 136:	482e      	ldr	r0, [pc, #184]	 ; (1f0 <_reset_init+0xd0>) ;
label_138:  ;
...
label_140:  ;
LDR(r0, 0x1001000);// 140:	482c      	ldr	r0, [pc, #176]	 ; (1f4 <_reset_init+0xd4>) ;
label_142:  ;
LDR(r2, 0x0000104);// 142:	4a2d      	ldr	r2, [pc, #180]	 ; (1f8 <_reset_init+0xd8>) ;
label_144:  ;
STR(r0, r3, r2);// 144:	5098      	str	r0, [r3, r2] ;
label_146:  ;
LDR(r2, r3, 0);// 146:	681a      	ldr	r2, [r3, #0] ;
label_148:  ;
LDR(r0, 0xfff3fff);// 148:	482c      	ldr	r0, [pc, #176]	 ; (1fc <_reset_init+0xdc>) ;
label_14a:  ;
...
label_150:  ;
LDR(r2, 0x0000100);// 150:	4a2b      	ldr	r2, [pc, #172]	 ; (200 <_reset_init+0xe0>) ;
label_152:  ;
...
label_15c:  ;
LDR(r4, 0xfcfffff);// 15c:	4c29      	ldr	r4, [pc, #164]	 ; (204 <_reset_init+0xe4>) ;
label_15e:  ;
...
label_168:  ;
LDR(r3, 0x4004900);// 168:	4b27      	ldr	r3, [pc, #156]	 ; (208 <_reset_init+0xe8>) ;
label_16a:  ;
LDR(r4, 0xfefff8f);// 16a:	4c28      	ldr	r4, [pc, #160]	 ; (20c <_reset_init+0xec>) ;
label_16c:  ;
...
label_17e:  ;
LDR(r3, 0x4006500);// 17e:	4b24      	ldr	r3, [pc, #144]	 ; (210 <_reset_init+0xf0>) ;
label_180:  ;
//Could not parse:  180:	7018      	strb	r0, [r3, #0] ;
label_182:  ;
LDR(r3, 0x4006400);// 182:	4b24      	ldr	r3, [pc, #144]	 ; (214 <_reset_init+0xf4>) ;
label_184:  ;
...
label_1c0:  ;
LDR(r0, 0x1ffff00);// 1c0:	4815      	ldr	r0, [pc, #84]	 ; (218 <_reset_init+0xf8>) ;
label_1c2:  ;
LDR(r1, 0x1ffff00);// 1c2:	4916      	ldr	r1, [pc, #88]	 ; (21c <_reset_init+0xfc>) ;
label_1c4:  ;
LDR(r4, 0x000005c);// 1c4:	4c16      	ldr	r4, [pc, #88]	 ; (220 <_reset_init+0x100>) ;
label_1c6:  ;
...
label_1ce:  ;
LDR(r2, 0x1ffff00);// 1ce:	4a15      	ldr	r2, [pc, #84]	 ; (224 <_reset_init+0x104>) ;
label_1d0:  ;
...
label_44e:  ;
LDR(r1, 0x4004700);// 44e:	4914      	ldr	r1, [pc, #80]	 ; (4a0 <configure_rgbled+0x54>) ;
label_450:  ;
LDR(r2, 0x0000103);// 450:	4a14      	ldr	r2, [pc, #80]	 ; (4a4 <configure_rgbled+0x58>) ;
label_452:  ;
...
label_45a:  ;
LDR(r3, 0x4004a00);// 45a:	4b13      	ldr	r3, [pc, #76]	 ; (4a8 <configure_rgbled+0x5c>) ;
label_45c:  ;
LDR(r0, 0xfffff8f);// 45c:	4813      	ldr	r0, [pc, #76]	 ; (4ac <configure_rgbled+0x60>) ;
label_45e:  ;
...
label_47a:  ;
LDR(r3, 0x4004c00);// 47a:	4b0d      	ldr	r3, [pc, #52]	 ; (4b0 <configure_rgbled+0x64>) ;
label_47c:  ;
...
label_48a:  ;
LDR(r2, 0x400ff04);// 48a:	4a0a      	ldr	r2, [pc, #40]	 ; (4b4 <configure_rgbled+0x68>) ;
label_48c:  ;
...
label_496:  ;
LDR(r2, 0x400ff0c);// 496:	4a08      	ldr	r2, [pc, #32]	 ; (4b8 <configure_rgbled+0x6c>) ;
label_498:  ;
...
label_4be:  ;
LDR(r2, 0x400ff04);// 4be:	4a03      	ldr	r2, [pc, #12]	 ; (4cc <turn_on_green_led+0x10>) ;
label_4c0:  ;
...
label_4d2:  ;
LDR(r2, 0x400ff04);// 4d2:	4a03      	ldr	r2, [pc, #12]	 ; (4e0 <turn_off_green_led+0x10>) ;
label_4d4:  ;
...
label_4e6:  ;
LDR(r2, 0x400ff04);// 4e6:	4a03      	ldr	r2, [pc, #12]	 ; (4f4 <toggle_green_led+0x10>) ;
label_4e8:  ;
...
label_4fa:  ;
LDR(r2, 0x400ff04);// 4fa:	4a03      	ldr	r2, [pc, #12]	 ; (508 <turn_on_red_led+0x10>) ;
label_4fc:  ;
...
label_50e:  ;
LDR(r2, 0x400ff04);// 50e:	4a03      	ldr	r2, [pc, #12]	 ; (51c <turn_off_red_led+0x10>) ;
label_510:  ;
...
label_522:  ;
LDR(r2, 0x400ff04);// 522:	4a03      	ldr	r2, [pc, #12]	 ; (530 <toggle_red_led+0x10>) ;
label_524:  ;
...
label_536:  ;
LDR(r2, 0x400ff0c);// 536:	4a02      	ldr	r2, [pc, #8]	 ; (540 <turn_on_blue_led+0xc>) ;
label_538:  ;
...
label_546:  ;
LDR(r2, 0x400ff0c);// 546:	4a02      	ldr	r2, [pc, #8]	 ; (550 <turn_off_blue_led+0xc>) ;
label_548:  ;
...
label_556:  ;
LDR(r2, 0x400ff0c);// 556:	4a03      	ldr	r2, [pc, #12]	 ; (564 <toggle_blue_led+0x10>) ;
label_558:  ;
